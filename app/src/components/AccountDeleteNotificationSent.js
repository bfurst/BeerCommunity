...
import { sendAccountDeleteToken, sendChangeEmailToken } from '../services/Api';
import { useAuth } from './AuthContext';

const AccountDeleteNotificationSent = ({ email }) => {
                ...
                <Card className='border border-secondary border-4' style={{ width: '46rem', borderRadius: 16, backgroundColor: 'whitesmoke', opacity: '0.9' }}>
                    <Card.Body>
                        ...
                        <div className="mb-3 fs-5 text-muted align-left">
                            In order to delete your account, it is required to verify your email address. Verification link has been sent to <a href={"mailto: " + email}>{email}</a>, please confirm your new email.
                        </div>
...
export default AccountDeleteNotificationSent;